...
def test_D10_D17_D19_D24_数据库计算最高风险并原子创建唯一任务(
    ...
    try:
        ...
        pg_database.execute(
            ...
            f"DELETE FROM public.institution_tenant_origin WHERE controlled_application_id='{application_id}' "
            f"AND tenant_id={tenant_id} AND origin_type='CONTROLLED_APPLICATION';"
