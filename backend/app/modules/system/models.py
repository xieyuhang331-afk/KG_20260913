...
PLATFORM_ORG_TABLE = TableSpec(
    ...
    columns=(
        ...
        ColumnSpec("admin_id", "BIGINT", foreign_key="user.id", unique=True),
        ColumnSpec("version", "BIGINT", nullable=False, default="1"),
        ColumnSpec("created_by", "BIGINT", foreign_key="user.id"),
        ColumnSpec("updated_by", "BIGINT", foreign_key="user.id"),
