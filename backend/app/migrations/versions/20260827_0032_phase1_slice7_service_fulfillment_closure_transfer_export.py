...
def _create_functions(milestone: str, case: str, transfer: str, export: str, family: str, oversight: str) -> None:
    ...
    _function(
        ...
        writers,
        declarations="operation_name VARCHAR; stored_digest BYTEA; stored_response JSONB; affected BIGINT; current_authority JSONB;",
    )
    _function(
