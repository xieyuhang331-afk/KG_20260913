		...
		<div className="space-y-5">
			<div>
				...
				<p className="mt-2 text-sm text-slate-500">
					仅展示 status=pending 的入驻申请，区域范围由后端权限控制。
				</p>
			</div>
			...
			>
				...
				/>
				<button
					className="h-10 rounded-md bg-pine px-4 text-sm font-medium text-white hover:bg-pine/90"
					type="submit"
				>
					查询
				</button>
