...
function enrollmentDetail() {
	return {
		...
		version: 5,
		identity: {
			verification_id: "0198c4a1-1111-7abc-8000-000000000505",
			enrollment_id: enrollmentId,
			member_id: "0198c4a1-1111-7abc-8000-000000000502",
			current_revision_id: "0198c4a1-1111-7abc-8000-000000000506",
			status: "VERIFIED",
			id_masked: "110***********1234",
			submitted_at: "2026-08-21T08:00:00+08:00",
			institution_checked_at: "2026-08-21T09:00:00+08:00",
			platform_decided_at: "2026-08-22T08:00:00+08:00",
			reason_codes: [],
			version: 3,
		},
		proxy: null,
		consents: [
			...
			consent_record_id: `0198c4a1-1111-7abc-8000-00000000051${index}`,
			enrollment_id: enrollmentId,
			document_type: documentType,
			document_version_id: `0198c4a1-1111-7abc-8000-00000000052${index}`,
			rendition_id: `0198c4a1-1111-7abc-8000-00000000053${index}`,
			locale: "zh-CN",
			choice: "ACCEPTED",
			status: "ACCEPTED",
			presented_at: "2026-08-22T08:00:00+08:00",
			accepted_at: "2026-08-22T08:01:00+08:00",
			withdrawn_at: null,
			version: 1,
		})),
		assignment: {
			...
			tenant_id: "0198c4a1-1111-7abc-8000-000000000501",
			subject_member_id: "0198c4a1-1111-7abc-8000-000000000502",
			therapist_id: "0198c4a1-1111-7abc-8000-000000000503",
			status: "ACCEPTED",
			service_scope_tags: ["OBESITY"],
			reason_code: null,
			service_case_id: caseId,
			created_at: "2026-08-22T09:00:00+08:00",
			decided_at: "2026-08-23T08:00:00+08:00",
			version: 2,
		},
	};
}
